...
Current Zephyr's Wemos S2 mini board supports the following features:
...
The usual ``flash`` target will work with the ``wemos_s2_mini`` board
...
.. _WEMOS S2 mini User Guide: https://www.wemos.cc/en/latest/s2/s2_mini.html
